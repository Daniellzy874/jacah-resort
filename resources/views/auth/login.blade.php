<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            ...
            <a data-bs-toggle="modal" data-bs-target="#forgotPassword" class=" underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" href="{{ route('password.request') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button id="btn" class="w-100 h-10 flex sm:justify-center items-center bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
        ...
        <div class="flex items-center justify-end mt-4 sm:justify-center items-center">
            ...
            <a href="{{route('register')}}" class="cursor-pointer ml-4 underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                {{ __('Sign up') }}
            </a>
        ...
        <div class="flex items-center justify-center mt-4" style="">
            <div style="display:flex; cursor:pointer;">
                <a href="{{route('google-auth')}}" style="display: inline-flex;" class=" shadow-md overflow-hidden sm:rounded-lg no-underline text-black">
