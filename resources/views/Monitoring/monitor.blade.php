<x-app-layout>
    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="py-4">
                <a href="{{route('monitor-item')}}"> <i class='bx bxs-chevron-left text-[50px] inline-flex p-20px bg-gray-200 cursor-pointer'></i></a>
            </div>
                        ...
                        <div class="flex pb-6 flex-column justify-center items-center relative">
                            ...
                            <div class="flex flex-column justify-center items-center mt-[50px] gap-2">
                                <div class="z-1 flex flex-column items-center mb-4">
                                    ...
                                    <h1 class="text-gray-500 text-sm">{{Carbon\Carbon::parse($data->last_activity)->diffForHumans()}}</h1>

                                    <span class="px-2 {{$data->isActive === 'online' ? 'bg-green-500' : 'bg-red-500' }} text-white rounded-md text-sm">{{$data->isActive === 'online' ? 'online' : 'offline'}}</span>
                                </div>
                            ...
                            <form id="myForm">
                                ...
                                <div class="modal-body">
                                    <div class='flex gap-[100px]'>
                                        <div class=''>
                                            <img src="{{asset('assets/image/pofile_pic_default/PROF-PIC.png')}}" class='w-[100px]' alt="" />
                                            <h1 class='font-bold capitalize'>{{$data->name}}</h1>

                                            <h1 class='text-xs'>{{$data->email}}</h1>
                                            <input type="hidden" name='number' />
                                            <h1 class='text-xs'>{{$data->mobile_number}}</h1>
                        ...
                        <div class="mb-8">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h1 class="text-green-500"><i class='bx bx-calendar-check text-[20px] mx-4'></i>{{$data->Date_in}}</h1>
                                        <h1 class="text-green-500"><i class='bx bx-time-five text-[20px] mx-4'></i>{{$data->Time_in}}</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <h1 class="text-red-500"><i class='bx bx-calendar-check text-[20px] mx-4'></i>{{$data->Date_out}}</h1>
                                        <h1 class="text-red-500"><i class='bx bx-time-five text-[20px] mx-4'></i>{{$data->Time_out}}</h1>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div class="mb-8">
                            ...
                            <table class="table">
                                <tr>
                                    ...
                                    <td class="w-[50%]">{{$data->price}}</td>
                                </tr>
                                <tr>
                                    <td>
                                        <h1 class="text-gray-500">Entrance fee:</h1>
                                    </td>
                                    <td class="w-[50%]">{{$data->entrance_fee}}</td>
                                </tr>
                                <tr>
                                    <td>
                                        <h1 class="text-gray-500">Peson count:</h1>
                                    </td>
                                    <td class="w-[50%]">x {{$data->personCount}}</td>
                                </tr>
                                <tr>
                                    <td>
