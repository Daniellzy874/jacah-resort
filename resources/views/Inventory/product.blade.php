        ...
        <div class="flex gap-2 max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4" style=" overflow:auto;">
                ...
                <div class="shadow-sm sm:rounded-lg p-6 text-gray-900 bg-white ">
                    ...
                    <form method="post" enctype='multipart/form-data'>
                        ...
                        <div class="py-2 flex gap-1">
                            <x-primary-button formaction="{{route('saveProduct')}}" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width: 80px;">
                                {{ __('Add') }}
                            </x-primary-button>
                            <x-primary-button formaction="{{route('editProduct')}}" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width: 80px;">
                                {{ __('Edit') }}
                            </x-primary-button>
                            <x-primary-button type="button" data-bs-toggle="modal" data-bs-target="#modalConfirmDelProd" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width:80px;">
                                {{ __('Remove') }}
                            </x-primary-button>
            ...
            <div class="w-full overflow-hidden sm:rounded-lg" style="overflow:auto;">
                ...
                <div class="bg-white shadow-sm mt-2 mb-2 p-6 text-gray-900">
                    ...
                    @viteReactRefresh
                    @vite('resources/js/InventoryJS/inventprod.js')
