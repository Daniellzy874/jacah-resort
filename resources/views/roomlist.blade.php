                ...
                <div class="shadow-sm sm:rounded-lg p-6 text-gray-900 bg-white ">
                    ...
                    <form method="post" enctype='multipart/form-data'>
                        ...
                        <div class="py-2 flex gap-1">
                            <x-primary-button formaction="{{route('saveroom')}}" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width: 80px;">
                                {{ __('Add') }}
                            </x-primary-button>
                            <x-primary-button formaction="{{route('editroom')}}" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width: 80px;">
                                {{ __('Edit') }}
                            </x-primary-button>
                            <x-primary-button type="button" data-bs-toggle="modal" data-bs-target="#modalConfirmDelroom" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width: 80px;">
                                {{ __('Remove') }}
                            </x-primary-button>
                        </div>
