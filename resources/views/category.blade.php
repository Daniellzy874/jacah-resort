                    ...
                    <form method="post" enctype='multipart/form-data'>
                        ...
                        <div class="gap-2">
                            ...
                            <div class="w-full mt-2">
                                <x-input-label class="text-2xl font-bold">Photo</x-input-label>
                                <x-room-photo />
                            </div>
                        </div>
                        <div class="py-2 flex gap-1">
                            <x-primary-button formaction="{{route('savecategory')}}" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width: 80px;">
                                {{ __('Add') }}
                            </x-primary-button>
                            <x-primary-button formaction="{{route('editcategory')}}" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width: 80px;">
                                {{ __('Edit') }}
                            </x-primary-button>
                            <x-primary-button type="button" data-bs-toggle="modal" data-bs-target="#modalConfirm" class="flex items-center justify-center h-8 bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700" style="width:80px;">
                                {{ __('Remove') }}
                            </x-primary-button>
