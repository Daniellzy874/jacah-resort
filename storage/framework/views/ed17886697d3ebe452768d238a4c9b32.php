...
<body>
    ...
    <div class="headerTop">
        <nav>
            <ul>
                <li><a class="navLink" href="<?php echo e(route('booking')); ?>">Booking</a></li>
                <li><a class="navLink activeNav" href="<?php echo e(route('transaction')); ?>">Payment</a></li>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" style=" height:75vh;  overflow:auto;">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div id="" class="p-2 text-gray-900">
                    ...
                    <?php echo app('Illuminate\Foundation\Vite')('resources/js/paymenthistory.js'); ?>
...
</script><?php /**PATH C:\Users\Billy Villanueva\OneDrive\Desktop\CapstoneProject\project\resources\views/CustomerUI/page/transaction.blade.php ENDPATH**/ ?>