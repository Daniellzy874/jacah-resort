...
<?php $component->withAttributes([]); ?>
    ...
    <title>JACAH | Login</title>
    <?php $__env->stopSection(); ?>
    <?php $__env->startSection('mess'); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','class' => 'block mt-1 w-full','style' => 'padding-right:40px;','type' => 'password','name' => 'password','required' => true,'autocomplete' => 'current-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
        ...
        <div class="block mt-4">
            ...
            <a data-bs-toggle="modal" data-bs-target="#forgotPassword" class=" underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" href="<?php echo e(route('password.request')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['id' => 'btn','class' => 'w-100 h-10 flex sm:justify-center items-center bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'btn','class' => 'w-100 h-10 flex sm:justify-center items-center bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700']); ?>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4 sm:justify-center items-center">
            ...
            <a href="<?php echo e(route('register')); ?>" class="cursor-pointer ml-4 underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
        ...
        <div class="flex items-center justify-center mt-4" style="">
            <div style="display:flex; cursor:pointer;">
                <a href="<?php echo e(route('google-auth')); ?>" style="display: inline-flex;" class=" shadow-md overflow-hidden sm:rounded-lg no-underline text-black">
...
<?php endif; ?><?php /**PATH C:\Users\Billy Villanueva\OneDrive\Desktop\CapstoneProject\project\resources\views/auth/login.blade.php ENDPATH**/ ?>