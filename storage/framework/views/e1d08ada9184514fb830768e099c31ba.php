...
<body>
        ...
        <section class="home section__home" id="home">
            <div class="home__container bd-container">
                <div class="home__data">
                    <div id="arrow_back">
                        <a data-bs-toggle="modal" data-bs-target="#modalConfirmCancellBooking" style="display: inline-flex; gap:10px;" href="<?php echo e(route('room')); ?>">
                    ...
                    <script>
                        function cancel() {
                            ...
                            window.location.href = '<?php echo e(route("redirect")); ?>';
                    ...
                    <form action="<?php echo e(route('pay')); ?>" method="POST">
                        ...
                        <div style="display: flex; gap:5px;">
                            <div class="full_container menu__content">
                                <div class="top_con">
                                    <h1 style="font-size:30px;"><?php echo e($data->category); ?></h1>
                                </div>
                                <div class="content_con">
                                    <div class="content_list">
                                        ...
                                        <div class="overflow-hidden shadow-sm sm:rounded-lg">
                                            ...
                                            <!-- input fields -->
                                            <div class="hidden">
                                                <input type="text" class="" name="name" id="" value="<?php echo e(Auth::user()->name); ?>" readonly required>
                                                <input type="numbers" name="cus_id" id="" value="<?php echo e(Auth::user()->id); ?>" readonly required>
                                                <input type="email" class="" name="email" id="email" value="<?php echo e(Auth::user()->email); ?>" readonly required>
                                                <input type="text" class="" name="mobile" id="" value="<?php echo e(Auth::user()->phone); ?>" readonly required>
                                                <!-- date -->
                                                <div id="reload"
                                                    style="padding-top: 10px; padding-left: 30px; padding-right: 30px; padding-bottom: 10px; ">
                                                    <input type="text" name="reserve_for" id="reserve" value="<?php echo e($data->category); ?>">
                                            ...
                                            <div id="profile_Field"
                                                ...
                                                <div style="padding-top: 10px; padding-left: 30px; padding-right: 30px;">
                                                    ...
                                                    <div>
                                                        <h1 class="text-xl font-bold capitalize"><?php echo e(Auth::user()->name); ?></h1>
                                                ...
                                                <div style="padding-top: 10px; padding-left: 30px; padding-right: 30px;">
                                                    ...
                                                    <h1 class="text-xl font-bold"><?php echo e(Auth::user()->email); ?></h1>
                                                </div>
                                                <div
                                                    style="padding-top: 10px; padding-left: 30px; padding-right: 30px; padding-bottom: 10px;">
                                                    <h1 style="font-size: 20px;">Mobile number<span
                                                            style="color: red; font-size: 15px; ">*</span></h1>
                                                    <h1 class="text-xl font-bold"><?php echo e(Auth::user()->phone); ?></h1>
                                                </div>
                                                ...
                                                <div style="padding-top: 10px; padding-left: 30px; padding-right: 30px;">
                                                    ...
                                                    <div class="flex">
                                                        ...
                                                        <a data-bs-target="#myQRcode" data-bs-toggle="modal" style="background-color: red; border:2px solid black; display:inline-flex;" class="ml-2 cursor-pointer"><img
                                                                src="<?php echo e(asset('assets/image/gcash.png')); ?>" style="height:50px;"></a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="bg-white rounded-md">
                                                            ...
                                                            <div id="modal-QR-body" class="modal-body">
                                                                <img src="<?php echo e(asset('assets/image/GCash-MyQR.png')); ?>" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="menu__content" style="width: 45%; height:70vh; position:relative; padding:10px;">
                                <div style="width: 100%; height:50%; background-color:transparent; border-radius:5px;">
                                    <div style="width: 100%; height:80%;">
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" style="height: 100%; width:100%;">
                                            <div class="carousel-inner" style="height: 100%;">
                                                <?php $__currentLoopData = $imageCarousel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ewan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="carousel-item <?php if($loop->first): ?> active <?php endif; ?>" style="height:100%;">
                                                    <img src="<?php echo e(asset($ewan->image)); ?>" class="d-block w-100 h-100"
                                    ...
                                    <h1 class="menu__name"><?php echo e($data->category); ?></h1>
                                </div>
                                <div style="height:15%; width:100%;">


                                    <?php echo app('Illuminate\Foundation\Vite')->reactRefresh(); ?>
                                    <?php echo app('Illuminate\Foundation\Vite')('resources/js/app1.js'); ?>
                                    <div id="date">
    ...
    <?php if (isset($component)) { $__componentOriginalb79b4e128055a839423343fc313b7a68 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb79b4e128055a839423343fc313b7a68 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-form','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalb79b4e128055a839423343fc313b7a68)): ?>
<?php $attributes = $__attributesOriginalb79b4e128055a839423343fc313b7a68; ?>
<?php unset($__attributesOriginalb79b4e128055a839423343fc313b7a68); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb79b4e128055a839423343fc313b7a68)): ?>
<?php $component = $__componentOriginalb79b4e128055a839423343fc313b7a68; ?>
<?php unset($__componentOriginalb79b4e128055a839423343fc313b7a68); ?>
<?php endif; ?>
    ...
    <script src="<?php echo e(asset('assets/js/darkTheme.js')); ?>"></script>
</body>
...
<script type="text/javascript">
    ...
    //     }
    // });
</script><?php /**PATH C:\Users\Billy Villanueva\OneDrive\Desktop\CapstoneProject\project\resources\views/CustomerUI\page\payment.blade.php ENDPATH**/ ?>