...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-100 h-10 flex sm:justify-center items-center bg-green-500 hover:bg-green-700 active:bg-green-700 focus:bg-green-700']); ?>
...
<?php endif; ?>
        ...
        <!-- <div class="flex items-center justify-end mt-4 sm:justify-center items-center">
            ...
            <a href="<?php echo e(route('room')); ?>" class="text-white no-underline rounded-md w-100 h-10 flex sm:justify-center items-center bg-red-500 hover:bg-red-700 active:bg-red-700 focus:bg-red-700">
                <?php echo e(__('Back')); ?>
...
</script><?php /**PATH C:\Users\Billy Villanueva\OneDrive\Desktop\CapstoneProject\project\resources\views/components/custom-form.blade.php ENDPATH**/ ?>